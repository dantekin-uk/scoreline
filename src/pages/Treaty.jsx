...
const treaty = capabilityBySlug.treaty;

const treatyCards = [
  { ...treaty.modules[0], icon: Target, layout: 'col-span-2 row-span-2 lg:col-span-6 lg:row-span-2 lg:min-h-[280px]' },
  { ...treaty.modules[1], icon: Layers, layout: 'col-span-2 lg:col-span-6 lg:min-h-[132px]' },
  { ...treaty.modules[2], icon: ShieldCheck, layout: 'col-span-1 lg:col-span-3 lg:min-h-[132px]' },
  { ...treaty.modules[3], icon: BarChart3, layout: 'col-span-1 lg:col-span-3 lg:min-h-[132px]' },
];
    ...
    <main>
      ...
      >
        <div
          ...
          style={{ backgroundImage: `url(${treaty.image})` }}
        />
        ...
        <div className="relative z-10 mx-auto h-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-full min-h-[280px] max-w-4xl flex-col pt-12 sm:pt-14">
            ...
            >
              ...
              >
                <span className="bg-gradient-to-r from-neutral via-white/90 to-secondary bg-clip-text text-transparent">{treaty.heroTitle}</span>
              </motion.h1>
              <p className="mb-4 max-w-2xl font-sans text-xs leading-relaxed text-white/75 sm:mb-5 sm:text-sm">{treaty.heroSummary}</p>
              <div className="flex flex-row items-center gap-2">
                <a href="#treaty" className="inline-flex items-center gap-1 rounded-full bg-white px-2.5 py-1 font-sans text-[10px] font-medium tracking-wide text-primary shadow-sm transition-colors hover:bg-secondary hover:text-white sm:px-4 sm:py-2 sm:text-xs">
                  Explore Treaty Capacity
                  <ArrowRight size={12} strokeWidth={2.25} />
                </a>
                <Link to="/capabilities/facultative" className="inline-flex items-center gap-1 rounded-full border border-white/25 bg-white/10 px-2.5 py-1 font-sans text-[10px] font-medium tracking-wide text-white backdrop-blur-md transition-colors hover:border-white/40 hover:bg-white/18 sm:px-4 sm:py-2 sm:text-xs">
                  Explore Facultative
      ...
      <section id="treaty" className="scroll-mt-24 py-12 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="mt-4 font-display text-lg font-bold leading-snug tracking-tight sm:text-xl lg:text-2xl lg:leading-snug">
              <span className="bg-gradient-to-r from-primary via-primary to-secondary bg-clip-text text-transparent">Intelligent Risk Transfer And Capital Protection</span>
            </h2>
            <p className="mt-3.5 max-w-xl font-sans text-xs leading-relaxed text-accent/65 sm:text-[13px]">
              Connecting complex regional risks with secure global capacity. We architect bespoke proportional and non-proportional programs to fortify your balance sheet and drive sustainable growth.
            </p>
          </motion.div>
      ...
      <CTA title={treaty.cta.title} text={treaty.cta.text} button={treaty.cta.button} />
    </main>
  );
};
